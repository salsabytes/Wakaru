...
const STRINGS: Record<string, Record<string, string>> = {
  id: {
    ...
    tiktokHeavy: '⚠️ video ini resolusinya kegedean buat player WA (1080p60/format berat) — Nalsa kirim sebagai file .mp4 ya, tinggal tap buat play di pemutar eksternal 📦',
  ...
  en: {
    ...
    tiktokHeavy: '⚠️ this video is too heavy for the WA player (1080p60/heavy format) — sent as .mp4 file instead, tap to play in an external player 📦',
