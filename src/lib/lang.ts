...
const STRINGS: Record<Lang, Record<string, string>> = {
  id: {
    ...
    prefixUsage: 'usage: {prefix}prefix <..> — sekarang: {prefixes} — mis. {prefix}prefix ! / atau {prefix}prefix ! / buat multi, {prefix}prefix none buat tanpa prefix',
  ...
  en: {
    ...
    prefixUsage: 'usage: {prefix}prefix <..> — current: {prefixes} — e.g. {prefix}prefix ! /, multi: {prefix}prefix ! /, bare: {prefix}prefix none',
    prefixSet: '✅ prefix: {prefixes}',
